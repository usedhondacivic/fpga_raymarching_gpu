...
LINMATH_H_FUNC void mat4x4_scale_aniso(mat4x4 M,
									   mat4x4 const a,
									   float x,
									   float y,
									   float z)
...
LINMATH_H_FUNC void mat4x4_translate_in_place(mat4x4 M,
											  float x,
											  float y,
											  float z)
{
...
LINMATH_H_FUNC void mat4x4_from_vec3_mul_outer(mat4x4 M,
											   vec3 const a,
											   vec3 const b)
{
	int i, j;
...
LINMATH_H_FUNC void mat4x4_rotate(mat4x4 R,
								  mat4x4 const M,
								  float x,
								  float y,
								  float z,
...
LINMATH_H_FUNC void mat4x4_perspective(mat4x4 m,
									   float y_fov,
									   float aspect,
									   float n,
									   float f)
...
LINMATH_H_FUNC void mat4x4_look_at(mat4x4 m,
								   vec3 const eye,
								   vec3 const center,
								   vec3 const up)
{
...
LINMATH_H_FUNC void mat4x4_arcball(mat4x4 R,
								   mat4x4 const M,
								   vec2 const _a,
								   vec2 const _b,
								   float s)
